...
Target coordinates can be manually entered or imported from the NINA catalog, the NINA Framing Assistant, or an attached planetarium program (e.g. Stellarium).
...
* **NINA Catalog**. Enter the name of your DSO in the field - incremental search is support.  Be sure to click on your selection to set the coordinates.
